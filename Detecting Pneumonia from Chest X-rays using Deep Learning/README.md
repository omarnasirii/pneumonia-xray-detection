...
📁 Dataset
Use the Chest X-Ray Images (Pneumonia) dataset from Kaggle. Place it inside a data/ folder like so:
...
IM-0001.jpeg (NORMAL) ➜ Predicted: Normal (Confidence: 0.12) person1_bacteria_1.jpeg (PNEUMONIA) ➜ Predicted: Pneumonia (Confidence: 0.91)
